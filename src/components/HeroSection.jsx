      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10'>
        <div className='flex flex-col items-center text-center space-y-8'>
          ...
          <div className='flex flex-col sm:flex-row gap-5 mt-4'>
            <button className='px-10 py-4 bg-slate-900 text-white font-bold rounded-md hover:bg-blue-600 transition-all shadow-lg hover:shadow-blue-200 active:scale-95'>
              Login with Wallet
            </button>
            <button className='px-10 py-4 bg-white text-slate-900 border-2 border-slate-900 font-bold rounded-md hover:bg-slate-900 hover:text-white transition-all active:scale-95'>
              View Public Ledger
            </button>
          </div>
